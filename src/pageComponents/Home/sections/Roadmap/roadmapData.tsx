...
export const roadmapData: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { task: 'Reach 15,000 token holders', major: true },
      {
  ...
  },
  {
    ...
    items: [
      {
        task: 'Establish partnerships with other major tokens',
      },
      { task: 'Reach 25,000 token holders', major: true },
      {
        task: 'Reach 75 million market cap',
        major: true,
      },
      { task: 'Reach 35,000 token holders', major: true },
      {
        task: 'Reach 100 million market cap',
        major: true,
      },
      { task: 'Reach 50,000 token holders', major: true },
    ],
  },
]
